// --- Resume Data Structure (Unified + Clean) ---
...
export const DEFAULT_CONTENT = {
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "Production tool for dynamically configuring mounting products, with ColdFusion + Vue.js backend/frontend integration.",
      tech: ["Vue.js", "Pinia", "ColdFusion", "JavaScript"],
    },
    {
      name: "Multithreaded Data Management System",
      description:
        "Spring Boot + MySQL application using thread pools, file processing, and concurrency-safe data operations.",
